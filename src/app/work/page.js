...
import { portfolioGroups } from "./portfolioData";

const portfolioRootId = "1bJSaLDWR7MeMEyhUmC9o-HZWWd4ynlND";
      ...
      <main className="work-page work-page-drive">
        ...
        <header className="work-topbar">
          ...
          <nav className="topnav" aria-label="Work navigation">
            ...
            <a href={`https://drive.google.com/drive/folders/${portfolioRootId}`}>
              Drive
            </a>
          </nav>
        </header>
        ...
        <section className="work-drive-hero">
          ...
          <div className="work-drive-pills">
            <span>{portfolioGroups.length} folders</span>
            <span>{totalVideos} videos</span>
            <span>Public Drive synced</span>
          </div>
        </section>
